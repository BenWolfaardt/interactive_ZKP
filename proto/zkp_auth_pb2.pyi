...
class RegisterRequest(_message.Message):
    ...
    y2: int
    def __init__(
        self, user: _Optional[str] = ..., y1: _Optional[int] = ..., y2: _Optional[int] = ...
    ) -> None: ...
...
class AuthenticationChallengeRequest(_message.Message):
    ...
    r2: int
    def __init__(
        self, user: _Optional[str] = ..., r1: _Optional[int] = ..., r2: _Optional[int] = ...
    ) -> None: ...

class AuthenticationChallengeResponse(_message.Message):
    __slots__: list = ["auth_id", "c"]
